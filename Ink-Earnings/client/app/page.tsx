...
export default function Home() {
  return (
    <>
      <Navbar publish={false} />
      <main className="overflow-y-hidden flex justify-center items-center w-[100vw] h-[80vh]">
        <div className="flex flex-col items-center justify-between lg:mb-40">
          <p className="text-2xl md:text-3xl text-[#4A90E2]">Wordly</p>
          <Image
            src="/pencil.png"
            width={400}
            height={87.93}
          ...
          />
          <p className="text-[.9rem] md:text-xl text-[#2D5B92]">
            Empowering Writers Everywhere
          </p>
          <p className="text-[.65rem] w-[60vw] text-center md:text-xs text-gray-500 mt-4">
